...
constexpr std::optional<Functionality> expected_func = Functionality::ClassMoveable; // Set to a specific Functionality value for local testing, or leave as nullopt to parse from command line arguments.
